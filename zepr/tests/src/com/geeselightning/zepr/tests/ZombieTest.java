...
public class ZombieTest {
    ...
    public void zombieDoesNoDamageToPlayerWhenAtMaxRange() {
        ...
        Zombie zombie = new Zombie(new Sprite(new Texture("zombie01.png")), new Vector2(player.getCenter().x, player.getCenter().y - Constant.ZOMBIERANGE), world, player, 1, 10);
    ...
    public void zombieDoesDamageToPlayerWhenInRange() {
        ...
        Zombie zombie = new Zombie(new Sprite(new Texture("zombie01.png")), new Vector2(player.getCenter().x, player.getCenter().y - Constant.ZOMBIERANGE + 5), world, player, 1, 10);
        double originalHealth = player.getHealth();
        zombie.attack(player, 0);
    ...
    public void zombieCannotAttackBeforeCooldownComplete() {
        ...
        Zombie zombie = new Zombie(new Sprite(new Texture("zombie01.png")), new Vector2(player.getCenter().x, player.getCenter().y ), world, player,1, 10);
        double originalHealth = player.getHealth();
        zombie.attack(player, 0);
        zombie.attack(player, 0);
