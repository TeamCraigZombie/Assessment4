...
public class PlayerTest {
    ...
    public void playerDoesNoDamageToZombieWhenAtMaxRange() {
        ...
        Zombie zombie = new Zombie(new Sprite(new Texture("zombie01.png")), new Vector2(0, Constant.PLAYERRANGE), world, player,1, 10, 1);
    ...
    public void playerDoesDamageToZombieWhenInRange() {
        ...
        Zombie zombie = new Zombie(new Sprite(new Texture("zombie01.png")), new Vector2(0, Constant.PLAYERRANGE - 10), world, player,1, 10, 1);
        double originalHealth = zombie.getHealth();
        player.attack(zombie, 0);
